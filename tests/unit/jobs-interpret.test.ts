...
describe("client_scope_creep custom detector", () => {
  ...
  const invoice = (clientId: string, amount: number, i: number) => ({ id: `inv--`, provider: "stripe", capability: null, resource_type: "invoice", external_id: `inv-`, title: "Invoice", summary: null, author: null, source_url: null, source_timestamp: ago(5), tags: [], metadata: { status: "paid", amount_paid: amount, client_id: clientId, currency: "usd" } });
