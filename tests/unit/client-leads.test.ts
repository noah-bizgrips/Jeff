...
import { ClientLeadIndex, emailHash, isClientLead } from "@/lib/jeff/clients/client-leads";
import { runMonitors } from "@/lib/jeff/monitors";
import { leadFollowupGap } from "@/lib/jeff/monitors/lead-followup-gap";
...
import { conditionsMatch, specificity, subjectFromRow } from "@/lib/jeff/rules/engine";
import { decide } from "@/lib/jeff/rules/precedence";
import { classifyTier } from "@/lib/jeff/rules/tiers";
import { describeRule, RuleInputSchema, type OperatingRule } from "@/lib/jeff/rules/schema";
import { CLIENT_LEAD_RULE_MONITORS, CLIENT_LEAD_RULE_NAME } from "@/lib/jeff/rules/apply";
import { extractCommitments } from "@/lib/jeff/commitments/extract";
import { commitmentRules } from "@/lib/jeff/commitments/store";
