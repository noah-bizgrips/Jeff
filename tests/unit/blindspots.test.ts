...
import type { BlindSpotCandidate, BlindSpotContext } from "@/lib/gomez/blindspots/types";
import { applyDailyCap, blindSpotSubject, detectBlindSpots, rankScore, severityOf, toFinding } from "@/lib/gomez/blindspots/detect";
import { unseenFindings } from "@/lib/gomez/blindspots/detectors/unseen-findings";
import { quietClient } from "@/lib/gomez/blindspots/detectors/quiet-client";
import { sourceVolumeDrop } from "@/lib/gomez/blindspots/detectors/source-volume-drop";
import { staleConnection } from "@/lib/gomez/blindspots/detectors/stale-connection";
import { untrackedDrift } from "@/lib/gomez/blindspots/detectors/untracked-drift";
import { crossSourceContradiction } from "@/lib/gomez/blindspots/detectors/cross-source-contradiction";
import { unansweredOwedToMe } from "@/lib/gomez/blindspots/detectors/unanswered-owed-to-me";
import { neglectedGoal } from "@/lib/gomez/blindspots/detectors/neglected-goal";
import { applyReview, sanitizeReview } from "@/lib/gomez/blindspots/interpret";
import { blindSpotPushPayload, shouldPushBlindSpotBatch } from "@/lib/gomez/blindspots/push";
import { shouldSendSignal } from "@/lib/gomez/attention/types";
import { alertEmoji, BLIND_SPOT_EMOJI } from "@/lib/gomez/push/emoji";
import { shouldPushAlert } from "@/lib/gomez/push/decide";
