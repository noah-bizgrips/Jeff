...
import { dailyBudgetUsd } from "@/lib/gomez/pricing";
import { listConnections } from "@/lib/integrations/store";
import { loadCounts, loadLiveDocs, loadNotes, loadSaved } from "@/lib/gomez/server-data";
import { DEMO_MISSIONS } from "@/lib/gomez/demo-data";
import { GomezProvider, type GomezInitial } from "@/components/gomez/store";
import { AppShell } from "@/components/gomez/AppShell";
import { PushManager } from "@/components/gomez/PushManager";
import { surfacedAlerts } from "@/lib/gomez/alerts/store";
import { getSettings } from "@/lib/gomez/settings-store";
import { atLeast } from "@/lib/gomez/alerts/importance";
import { getBrainState } from "@/lib/gomez/brain/load";
import { EMPTY_BRAIN_STATE } from "@/lib/gomez/brain/state";
 ...
 */
export default async function GomezLayout({ children }: { children: React.ReactNode }) {
