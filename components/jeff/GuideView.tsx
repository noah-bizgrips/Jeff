...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    how: [
      ...
      "Push notifications (home-screen app): Settings → Notifications on this device → Enable. Toggles for alerts, briefings, goal alerts and opportunity alerts. Each push starts with its emoji: 🚨 urgent · ⚠️ important · 🎯 goal · 💡 opportunity · 💳 payment · 📉 cash flow · 🧲 leads · ⏳ pipeline · 🤝 commitment · 📣 ads · 📋 portal task · ☀️ daily brief · 📊 weekly · 🗓️ monthly.",
