...
const CATEGORY_LABEL: Record<string, string> = {
  ...
  client_scope_creep: "SCOPE CREEP",
  follow_through: "FOLLOW-THROUGH",
  relationship_quiet: "RELATIONSHIP QUIET",
  relationship_promise: "PROMISE",
  referral_source_declining: "REFERRAL SOURCE",
  contact_resurfaced: "CONTACT RESURFACED",
  important_date: "IMPORTANT DATE",
  time_allocation_mismatch: "TIME ALLOCATION",
  attention_fragmentation: "ATTENTION COST",
  personal_project_stalled: "PERSONAL PROJECT",
  personal_renewal_due: "PERSONAL RENEWAL",
  new_recurring_charge: "NEW RECURRING CHARGE",
  duplicate_tool: "DUPLICATE TOOL",
  price_increase: "PRICE INCREASE",
  unused_software: "UNUSED SOFTWARE",
  annual_renewal_upcoming: "ANNUAL RENEWAL",
  webhook_broken: "BROKEN CHANNEL",
  repeated_error: "REPEATED ERROR",
  manual_repetition: "MANUAL REPETITION",
  client_engagement_drop: "CLIENT ENGAGEMENT",
  client_missed_meeting: "MISSED MEETINGS",
  client_negative_signal: "CLIENT SIGNAL",
};
