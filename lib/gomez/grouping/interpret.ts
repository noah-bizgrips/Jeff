...
/**
 * Gomez's interpretation of a grouped situation: ONE budget-guarded model call
...
const SYSTEM = `You are Gomez, a private operations analyst for BizGrips (a small web/marketing agency). You are given ONE grouped situation: several alerts, findings and follow-through items that all point at the same client, goal, workflow or contact.
