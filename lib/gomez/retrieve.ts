...
export function retrieve(docs: GomezDoc[], question: string, scope = "all", limit = 6): GomezDoc[] {
...
export function linksFor(items: GomezDoc[]): [string, string, string[]][] {
...
export function extractiveAnswer(question: string, refs: GomezDoc[], mode: "demo" | "live") {
  if (!refs.length)
