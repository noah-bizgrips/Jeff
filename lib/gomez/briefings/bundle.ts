...
import { money } from "@/lib/gomez/alerts/engine";
...
export function buildTemplate(b: BriefingBundle): BriefingSummary {
  ...
  if (suggestion) recommends.push({ title: "A suggestion from Gomez's Jobs", detail: `${suggestion.slice(0, 500)} Confirm or discard it in Memory & Rules.`, ref_kind: "none", ref_id: null, importance: "informational" });
