import { bareAddress, classifyAuthor, type AuthorType } from "@/lib/gomez/rules/engine";
...
/** Confidence ceiling for a promise from someone Gomez has no relationship record for. */
