        ...
        for (const c of cpls) {
          if (c.leads >= MIN_LEADS && c.cpl > CPL_FACTOR * med) {
            findings.push({
              ...
              interpretation:
                "Interpretation: this campaign buys leads much less efficiently than the rest of the account. Common causes: audience fatigue, creative decay, or a broader objective. Consider pausing or reallocating — a change Gomez will only prepare, not make.",
