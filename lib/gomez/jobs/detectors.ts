...
import type { CandidateFinding, Monitor, SourceRow } from "@/lib/gomez/monitors/types";
import { clientIdOf, clientIndex, DAY, groupBy, isActiveClient, str } from "@/lib/gomez/monitors/portal-shared";
import { money, num, tsOf } from "@/lib/gomez/monitors/finance-shared";
import type { DetectorContext, DetectorSpec } from "./types";
import type { ExtendedContext } from "@/lib/gomez/monitors/types";
...
import { timeAllocationMismatch } from "@/lib/gomez/monitors/time-allocation";
import { attentionFragmentation } from "@/lib/gomez/monitors/attention-cost";
...
import { duplicateLeadEvents, manualRepetition, repeatedError, webhookBroken } from "@/lib/gomez/monitors/automation-audit";
