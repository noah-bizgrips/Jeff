...
/** Palette used by the canvas for tones (matches the Gomez Black theme). */
export const BRAIN_COLORS: Record<SourceTone | "gomez" | "gomezBright" | "inactiveNode" | "inactiveEdge", string> = {
  gomez: "#4DA3FF",
  gomezBright: "#78BEFF",
  inactiveNode: "#45454D",
  inactiveEdge: "#202026",
