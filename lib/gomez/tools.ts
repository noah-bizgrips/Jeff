...
import { MEMORY_RULE_TOOLS, runMemoryRuleTool } from "@/lib/gomez/rules/tools";
import { GOAL_TOOLS, runGoalTool } from "@/lib/gomez/goals/tools";
import { OPS_TOOLS, runOpsTool } from "@/lib/gomez/ops/tools";
import { CLIENT_TOOLS, runClientTool } from "@/lib/gomez/clients/tools";
import { BLIND_SPOT_TOOLS, runBlindSpotTool } from "@/lib/gomez/blindspots/tools";
import { JOB_TOOLS, runJobTool } from "@/lib/gomez/jobs/tools";
import { OBLIGATION_TOOLS, runObligationTool } from "@/lib/gomez/obligations/tools";
...
export const GOMEZ_TOOLS: Anthropic.Beta.BetaTool[] = [
  {
    name: "get_connection_status",
    description: "Lists Gomez's integrations and their current status (connected, limited, not configured, etc.). Never returns credentials.",
  ...
  },
  {
    name: "create_mission",
    description:
      "Creates a SANDBOX-ONLY mission draft for the owner to review. It never executes anything and cannot target production. Use when the owner asks Gomez to prepare, investigate, or draft work.",
    input_schema: {
      type: "object",
      properties: {
