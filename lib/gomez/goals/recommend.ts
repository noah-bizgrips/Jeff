 ...
 * Gomez can prepare, and whether approval is required. No ROI claims.
 */
  ...
  for (const v of t.violations) {
    ...
    if (v.key === "cac") {
      out.push({
        ...
        downside: "Reallocating budget can reduce volume; changes need your approval and are executed only outside Gomez.",
      ...
      out.push({
        ...
        downside: "Depends on the fix; Gomez only prepares analysis here.",
