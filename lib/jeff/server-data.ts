...
import type { SavedAnswer } from "@/components/jeff/store";
...
export async function loadLiveDocs(supabase: SupabaseClient, limit = 300): Promise<JeffDoc[]> {
...
export async function loadNotes(supabase: SupabaseClient): Promise<JeffDoc[]> {
