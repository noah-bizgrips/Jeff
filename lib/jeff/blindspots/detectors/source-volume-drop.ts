    ...
    for (const provider of providers) {
      ...
      out.push({
        ...
        interpretation: syncProblem
          ? "The source is not delivering data, so Jeff's picture of this area is stale — findings and briefings built on it are unreliable until the connection is fixed."
