import { inQuietHours, localTime, type OwnerSettings } from "@/lib/jeff/settings";
import { BLIND_SPOT_EMOJI } from "@/lib/jeff/push/emoji";
...
export function blindSpotPushPayload(titles: string[]): { title: string; body: string; url: string; tag: string } {
  ...
  return {
    title: `${BLIND_SPOT_EMOJI} Jeff noticed something you might be missing`,
