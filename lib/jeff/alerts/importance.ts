import { IMPORTANCE_LEVELS, inQuietHours, quietHoursEnd, type Importance, type OwnerSettings } from "@/lib/jeff/settings";
 ...
 * (notify during the day) < urgent (notify immediately) < actionable (Jeff
...
export interface ImportanceInput {
  ...
  urgent?: boolean;
  /** Jeff has a concrete prepared action available. */
  actionable?: boolean;
